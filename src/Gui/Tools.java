...
public class Tools {
    ...
    /**
     * Metodo que recibe una pila y convierte su contenido en un documento en
     * formato HTML para su posterior visualización. El metodo hace usa copia
     * profunda para asegurar que no se toquen o destruyan los datos de la pila
    ...
    /**
     * Metodo que inyecta código HTML en un documento buscando la marca
     * <code>script</code>, esto es util para delegar tareas que no se deben o
     * quieren realizar en el procesamiento principal.
     *
     * @param p
     * @param texto
     * @return
